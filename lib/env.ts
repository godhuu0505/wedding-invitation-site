...
export const getWeddingEnv = (): WeddingEnvironment => {
  ...
  envCache = {
    ...
    groomNameFullEn: process.env.NEXT_PUBLIC_GROOM_NAME_FULL_EN || 'Naoto Ito',
    groomFamilyNameJp: process.env.NEXT_PUBLIC_GROOM_FAMILY_NAME_JP || '伊藤',
    groomFirstNameJp: process.env.NEXT_PUBLIC_GROOM_FIRST_NAME_JP || '尚人',
    groomFamilyNameEn: process.env.NEXT_PUBLIC_GROOM_FAMILY_NAME_EN || 'Ito',
    groomFirstNameEn: process.env.NEXT_PUBLIC_GROOM_FIRST_NAME_EN || 'Naoto',
    ...
    brideNameFullEn: process.env.NEXT_PUBLIC_BRIDE_NAME_FULL_EN || 'Yui Kobayashi',
    brideFamilyNameJp: process.env.NEXT_PUBLIC_BRIDE_FAMILY_NAME_JP || '小林',
    brideFirstNameJp: process.env.NEXT_PUBLIC_BRIDE_FIRST_NAME_JP || '結衣',
    brideFamilyNameEn: process.env.NEXT_PUBLIC_BRIDE_FAMILY_NAME_EN || 'Kobayashi',
    brideFirstNameEn: process.env.NEXT_PUBLIC_BRIDE_FIRST_NAME_EN || 'Yui',
    ...
    brideBloodType: process.env.NEXT_PUBLIC_BRIDE_BLOOD_TYPE || 'A型',
    brideOccupation: process.env.NEXT_PUBLIC_BRIDE_OCCUPATION || '会社員',
    brideHobby: process.env.NEXT_PUBLIC_BRIDE_HOBBY || '読書',
